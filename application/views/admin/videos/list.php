								...
								<table class="table table-striped table-bordered" id="sample_1">
									...
									<form method="GET" action="<?=@$base?>">
										<tr>
											...
											<td width='10%'></td>
											<th width='20%'></th>
											<td width='30%'><input type="text" class="form-control" placeholder="Tên" name="title" value="<?=@$name?>"></td>
											<td width='25%' style="text-align: center"><button type="submit" class="btn btn-default btn-fill">Tìm kiếm</button></td>
										</tr>
									</form>
									<tbody>
									<?php if($list) foreach ($list as $item){ ?>
										<tr class="odd gradeX">
											<td><?=@$item->id?></td>
											<td><image src="<?=$item->thumb?>" height="40px"></td>
											<td><a href="<?=@base_url('videos/'.$item->alias)?>" class="btn btn-sm btn-fill btn-success"><i class="fa fa-eye"></i> Preview</a></td>
