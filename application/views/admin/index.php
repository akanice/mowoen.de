			...
			<div class="col-lg-4 col-md-6 col-sm-6">
				<div class="card">
					<div class="header">
						...
						<p class="category">Các sản phẩm mới nhất</p>
					</div>
					<div class="content">
						<ul>
						<?php if (@$newest_products) {foreach (@$newest_products as $item) { ?>
							<li><i class="fa fa-user"></i> <a href="<?=base_url('admin/products/edit/'.$item->id)?>" target="_blank"><?=$item->title?></a></li>
						<?php }} ?>
						</ul>
					</div>
				</div>
