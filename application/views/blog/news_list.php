                                    ...
                                    foreach ($news as $item) {?>
										<li class="list-post clearfix">
											<article id="post-904" class="item hentry">
												<div class="thumbnail">
													<a class="penci-image-holder penci-lazy" href="#" title="<?=@$item->title;?>" style="display: inline-block; background-image: url('<?=$item->thumb?>');">
													</a>
												</div>
												<div class="content-list-right content-list-center">
													<div class="header-list-style"> <span class="cat"><a class="penci-cat-name" href="#" rel="category tag">
														<?php if (isset($item->categoryid) && ($item->categoryid != ''))
															...
															?>
														<?=$space?><a href="<?=base_url('blog/category/').$n['alias']?>"><?=@$n['title']?></a> 
														<?php $space=', ';} ?>
													</a></span>
														<h2 class="entry-title grid-title"><a href="<?=@base_url('blog/'.$item->alias)?>"><?=@$item->title?></a></h2>
							...
							<ul>
								...
								<li class="clearfix">
									<div class="fleft article-thumb">
										<a href="<?=@base_url('blog/'.$item->alias)?>" class="image-holder fix-size" style="background-image:url('<?=@$item->thumb?>');display:inline-block"></a>
									</div>
									<div class="article-title">
										<a href="<?=@base_url('blog/'.$item->alias)?>"><h4 class="article-title"><?=@$item->title?></h4></a>
									</div>
								</li>
								<?php } ?>
							</ul>
