								...
								<table class="table table-striped table-bordered" id="sample_1">
									...
									<?php if($list) foreach ($list as $item) {?>
										<tr class="odd gradeX">
											...
											<td style="text-align: center"><a href="<?=@base_url('admin/pages/edit/'.$item->id)?>"><i class="fa fa-pencil"></i> Sửa</a> | <a href="<?=@base_url('admin/pages/delete/'.$item->id)?>" onclick="return confirm('Bạn có chắc chắn muốn xóa không?')" ><i class="fa fa-trash"></i> Xóa</a></td>
										</tr>
										<?php } ?>
									</tbody>
								</table>
